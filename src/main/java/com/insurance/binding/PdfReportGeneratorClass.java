...
public class PdfReportGeneratorClass {

	public void exportPdfReport(List<PlanResponse> planResponses, HttpServletResponse httpServletResponse) throws Exception, IOException {
		...
		for(PlanResponse plan : planResponses) {
